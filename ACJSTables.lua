...
Windows = {
    ...
    AClang.trans('Front Right Window'),
    AClang.trans('Rear Left Window'),
    AClang.trans('Rear Right Window'),
    AClang.trans('Front Windscreen'),
    AClang.trans('Rear Windscreen'),
    AClang.trans('Mid Left'),
    AClang.trans('Mid Right')
}
